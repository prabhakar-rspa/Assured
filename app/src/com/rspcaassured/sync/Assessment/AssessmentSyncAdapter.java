...
public class AssessmentSyncAdapter extends AbstractThreadedSyncAdapter {
     ...
     */
    public AssessmentSyncAdapter(Context context, boolean autoInitialize,
    ...
    public void onPerformSync(Account account, Bundle extras, String authority,
        ...
        if (account != null) {
            ...
            final AssessmentListLoader assessmentLoader = new AssessmentListLoader(getContext(), user, null);
            if (syncDownOnly) {
                assessmentLoader.syncDown();
            } else {
                assessmentLoader.syncUp(); // does a sync up followed by a sync down
            }
        }
    }
}
